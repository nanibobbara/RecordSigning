            ...
            using (var channel = connection.CreateModel())
            {
                ...
                consumer.Received += (model, ea) =>
                {
                    try
                    {
                        ...
                        channel.BasicPublish(exchange: _exchangeName, routingKey: _destinationRoutingKey, basicProperties: null, body: messageBytes);

                        // Acknowledge the message to remove it from the source queue
